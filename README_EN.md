...
# Remove containers and networks completely
docker compose down
...
> Alternatively, containers can be managed via the Docker Desktop GUI:
> Sidebar → *Containers* → stop / start / delete containers.
